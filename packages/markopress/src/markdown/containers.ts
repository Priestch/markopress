...
export interface ContainerOptions {
  // Custom container types to register
  types?: string[];
}
 ...
 */
export function setupContainers(md: MarkdownIt, options: ContainerOptions = {}): void {
 ...
 */
function setupGitHubAlerts(md: MarkdownIt): void {
 ...
 */
export function setupDetails(md: MarkdownIt): void {
